...
module Api
  class ScoresApiController < Api::ApiController
    ...
    def_param_group :mode do
      ...
      param :weapons, ["true", "false"], desc: "Default is true"
      param :physics,
        ["pql", "turbo", "vql", "classic"],
        desc: "Default is turbo, turbo is same as pql, classic is same as vql"
    end
